          ...
          <div class="container-fluid">
            ...
            <div class="navbar-header">
             <!--  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <a class="navbar-brand" href="#<?php echo site_url('dashboard'); ?>">WAZOMONI INTERNATIONAL</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                     <li class="nav-item">
                        <a href="http://localhost/ci-crud-master/index.php/index1" class="nav-link">Home</a>
                    </li>

                     <li class="nav-item">
                        <a href="http://localhost/ci-crud-master/home" class="nav-link">Login</a>
                    </li>


                    <li class="nav-item">
                        <a href="http://localhost/ci-crud-master/users/add" class="nav-link">Singnup</a>
                    </li>
              ...
              <!-- <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <!-- <ul class="dropdown-menu">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> Messag</a></li>
